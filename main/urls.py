...
urlpatterns = [
    ...
    path('classroom/<int:classroomID>/topic/<int:topicID>/exercise/<int:exerciseID>/start/', views.start_exercise, name='start_exercise'),
    path('classroom/<int:classroomID>/topic/<int:topicID>/exercise/<int:exerciseID>/question/<int:questionID>/next/', views.next_question, name='next_question'),
    ...
    path('classroom/<int:classroomID>/topic/<int:topicID>/exercise/<int:exerciseID>/delete/', views.delete_exercise, name='delete_exercise'),
    path('classroom/<int:classroomID>/topic/<int:topicID>/exercise/<int:exerciseID>/question/<int:questionID>/delete/', views.delete_question, name='delete_question'),
    path('classroom/<int:classroomID>/topic/<int:topicID>/exercise/<int:exerciseID>/question/<int:questionID>/quit/', views.quit_exercise, name='quit_exercise'),
]